...
const AddDoctor = () => {
  ...
  // const {  } = useSelector((state) => state.doctors);
    ...
    <div className="py-1 px-1">
      ...
      <div className="bg-white w-full rounded shadow px-4">
        ...
        <form onSubmit={formik.handleSubmit} className="p-6 space-y-2">
         ...
         <label className="block font-semibold pt-2">Gender-specific care</label>
        <div className="flex gap-4">
          <label>
            <input
              ...
              onChange={() => formik.setFieldValue("genderSpecificCare", true)}
          ...
          <label>
            <input
              ...
              value="false"
              className="cursor-pointer"
              onChange={() => formik.setFieldValue("genderSpecificCare", false)}
              checked={formik.values.genderSpecificCare === false}
            />{" "}
            No
          </label>
        </div>
        {formik.errors.genderSpecificCare && formik.touched.genderSpecificCare && (
         ...
         <label className="block font-semibold pt-2">Pediatric Specialist</label>
            <div className="flex gap-4">
            <label>
          <input
            type="radio"
            ...
            value="true"
            className="cursor-pointer"
            onChange={() => formik.setFieldValue('pediatricSpecialist', true)}
          /> Yes
        </label>
        <label>
          <input
            ...
            value="false"
            className="cursor-pointer"
            onChange={() => formik.setFieldValue('pediatricSpecialist', false)}
          /> No
        </label>
            </div>
            {formik.errors.pediatricSpecialist && formik.touched.pediatricSpecialist && (
            <p className="text-red-600 text-sm">{formik.errors.pediatricSpecialist}</p>
            )}
