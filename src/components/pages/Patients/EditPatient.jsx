...
const EditPatient = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      dob: selectedPatient?.[0].dob || "",
      gender: selectedPatient?.[0].gender || "",
      phone: selectedPatient?.[0].phone || "",
      patientCode: selectedPatient?.[0].patientCode || "",
      country: selectedPatient?.[0].country || "",
      medicareNumber: selectedPatient?.[0].medicareNumber || "",
      address: selectedPatient?.[0].address || "",
      state: selectedPatient?.[0].state || "",
      postcode: selectedPatient?.[0].postcode || "",
      height: selectedPatient?.[0].height || "",
      weight: selectedPatient?.[0].weight || "",
    },
